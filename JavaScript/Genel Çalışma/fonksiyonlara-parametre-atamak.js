//Fonksiyonlara Parametre Atamak ve Fonksiyondan Geri Dous Almak
...
let firstName = "Lorem" //global degisken

function greetings(firstName="", lastName="") { //default parametre aliyor

    //console.log(`Merhaba ${firstName ? firstName : " "}`)
    console.log(`Merhaba ${firstName}`)
    console.log(`Merhaba ${firstName} ${lastName}`) //lastName'e boşluk vermeseydik undefined verirdi
} 
console.log(firstName) //Lorem degisken  
